...
$(document).on("click", ".giphy", function (event) {
    ...
    var giphy = $(this);
    var status = giphy.data("status");
    console.log(status);
    console.log(giphy.data("animate"));
    if (status === "still") {
        console.log("The status is still");
        giphy.attr({
        ...
        console.log("The status is animate");
        giphy.attr({
...
// - Add rating to image - DONE
// - Add Still/Animate URLs as data - DONE
